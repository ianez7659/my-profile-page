...
export default function ProjectCard({
  ...
  return (
    ...
    >
      <Link
        href={`/projects/${slug}`}
        className="group rounded-2xl shadow-lg p-4 bg-white text-gray-900 transform transition duration-300 hover:scale-[1.02] hover:shadow-2xl block relative h-full flex flex-col"
      >
